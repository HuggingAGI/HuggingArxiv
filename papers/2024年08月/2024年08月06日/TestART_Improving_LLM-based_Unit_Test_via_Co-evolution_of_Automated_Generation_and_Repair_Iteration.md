# TestART：借助自动化生成与修复的协同迭代，提升 LLM 单元测试的效能。
...
> 单元测试虽关键，但耗时费力。现有自动化方法多基于SBST和语言模型。近期，LLM展现出卓越的推理与生成能力，但仍面临生成高质量测试用例的挑战：无效测试、缺乏反馈、重复问题。为此，我们提出TestART，一种结合LLM优势并克服其局限的新方法。TestART通过自动化生成与修复迭代，提升测试质量。它利用模板修复技术，通过提示注入避免重复，并从通过的测试中提取覆盖信息以增强测试充分性。实验显示，TestART生成的测试用例通过率高达78.55%，行覆盖率达90.96%，显著优于同类方法。
...
![TestART：借助自动化生成与修复的协同迭代，提升 LLM 单元测试的效能。](../../../paper_images/2408.03095/motivation.jpg)

![TestART：借助自动化生成与修复的协同迭代，提升 LLM 单元测试的效能。](../../../paper_images/2408.03095/TestART.jpg)

![TestART：借助自动化生成与修复的协同迭代，提升 LLM 单元测试的效能。](../../../paper_images/2408.03095/prompt.jpg)

![TestART：借助自动化生成与修复的协同迭代，提升 LLM 单元测试的效能。](../../../paper_images/2408.03095/RQ2.jpg)
