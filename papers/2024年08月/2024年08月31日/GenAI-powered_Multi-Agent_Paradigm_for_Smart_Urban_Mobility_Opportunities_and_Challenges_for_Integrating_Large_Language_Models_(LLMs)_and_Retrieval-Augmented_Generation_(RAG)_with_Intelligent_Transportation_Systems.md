# GenAI 驱动的多智能体范式在智能城市交通中的应用：探讨如何将 LLM 和 RAG 与智能交通系统结合，以及面临的机遇与挑战。
...
> 随着生成式AI技术的进步，多智能体系统正被广泛应用于智慧城市，以提升其功能与效率。本文深入探讨了大型语言模型（LLM）与新兴的检索增强生成（RAG）技术在智能交通系统（ITS）中的革新潜力，旨在为城市交通难题提供创新解法。我们首先全面梳理了当前移动数据、ITS及互联车辆（CV）应用的最新进展。在此基础上，我们剖析了RAG技术的核心逻辑，并探讨了将其融入智能移动领域的广阔前景。我们构想了一个概念框架，旨在打造能够智能对话、高效服务于城市通勤者、交通运营商及决策者的多智能体系统。我们的方法致力于推动一种自主智能的交通管理新模式，该模式（a）通过科学咨询减少交通拥堵、事故与碳排放，（b）增强公众参与与教育，促进参与式移动管理，以及（c）自动化关键交通管理任务，推动ITS平台如数据分析、知识表示及交通模拟的发展。通过融合LLM与RAG技术，我们力求突破传统基于规则的多智能体系统的局限，开创一个更可扩展、直观且自动化的多智能体新范式，引领ITS与城市交通的革新发展。
...
[Arxiv](https://arxiv.org/abs/2409.00494)