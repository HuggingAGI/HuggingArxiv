# HoneyComb：一款灵活的基于LLM的代理系统，专为材料科学领域设计。
...
> 专门化的大型语言模型 (LLM) 在解决材料科学复杂任务方面展现出潜力，但常因依赖过时知识而面临挑战。为此，我们推出了 HoneyComb，首个专为材料科学设计的 LLM 代理系统。HoneyComb 结合了高质量的材料科学知识库 (MatSciKB) 和先进的工具集 (ToolHub)，以提升其针对材料科学的推理和计算能力。MatSciKB 基于可靠文献构建，而 ToolHub 则通过归纳方法优化 API 工具。此外，HoneyComb 的自适应检索器确保了任务的准确性和相关性。实验显示，HoneyComb 在材料科学任务中显著超越基准模型，有效填补了 LLM 能力与领域需求间的鸿沟。其灵活框架还可扩展至其他科学领域，预示着在推动科学研究和应用中的广泛潜力。
...
[Arxiv](https://arxiv.org/abs/2409.00135)