...
> 随着 LLM 的持续进步，它们与基于代理的模拟的更深度融合为解析复杂社会系统带来了革命性的可能。但这并非轻而易举，涉及诸多挑战。本文深入探讨了如何系统构建和应用 LLM 增强的社会模拟，并展望了该领域的研究前景。我们坚信，这种结合为研究者提供了强大的工具，助力构建更为精细、逼真且全面的复杂系统与人类行为模型。
