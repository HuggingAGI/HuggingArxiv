...
这篇论文摘要主要讨论了大型语言模型（LLMs）在代码生成领域的应用，包括其在软件开发中的实际应用（如GitHub Copilot），以及相关的技术进步。论文提供了一个全面的文献综述，专注于LLM在代码生成上的应用，并讨论了该领域的最新进展、性能评估、历史演变以及实际应用中的挑战与机遇。此外，论文还提到了一个专门的资源网站，用于持续更新和分享该领域的最新动态。因此，这篇论文最适合归类为LLM应用。` `软件开发` `人工智能`
