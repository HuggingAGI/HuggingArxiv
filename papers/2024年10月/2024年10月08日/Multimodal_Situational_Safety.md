...
> 多模态大型语言模型 (MLLM) 正在迅速发展，成为与人类及其环境互动的多模态助手，展现出令人印象深刻的能力。然而，这种复杂性也带来了显著的安全隐患。本文首次评估并分析了一个名为“多模态情境安全”的新挑战，探讨了安全考虑如何随用户或代理所处情境而变化。我们指出，MLLM 在响应时，无论是通过语言还是行动，通常需在其视觉上下文中评估语言查询的安全性。为此，我们开发了多模态情境安全基准 (MSSBench)，包含 1,820 个语言查询-图像对，其中一半安全，另一半不安全，以评估当前 MLLM 的情境安全性能。我们还设计了评估框架，分析显式安全推理、视觉理解和情境安全推理等关键方面。研究发现，当前 MLLM 在指令跟随设置中难以应对这些细微的安全问题，且难以同时解决所有情境安全挑战，这为未来研究指明了方向。此外，我们通过多代理管道协调解决安全挑战，显著提升了原始 MLLM 的安全性能。代码和数据详见：mssbench.github.io。
