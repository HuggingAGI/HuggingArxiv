...
> 本研究探索了 LLM 代理检测并修正 AI 生成内容中幻觉的能力。一个代理创建了关于虚构丹麦艺术家 Flipfloppidy 的博客，另一个代理负责审查事实错误。多数 LLM 都“幻想”了这位艺术家的存在。在 4,900 次测试中，Llama3-70b 和 GPT-4 等高级模型几乎完美地识别了幻觉，并在 85% 至 100% 的案例中成功修正了输出。这些发现展示了高级 AI 模型提升内容准确性和可靠性的潜力，为优化 AI 工作流程提供了新思路。
...
[Arxiv](https://arxiv.org/abs/2410.14262)