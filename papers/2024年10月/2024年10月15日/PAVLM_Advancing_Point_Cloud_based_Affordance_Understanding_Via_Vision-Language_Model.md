...
> Affordance 理解对机器人与物理世界的互动至关重要。尽管 VLM 在机器人操作的高级推理方面表现出色，但在细微物理特性理解上仍显不足。我们提出的 PAVLM 框架，通过结合预训练语言模型的多模态知识，显著提升了点云的 3D Affordance 理解。实验结果显示，PAVLM 在 3D-AffordanceNet 基准测试中表现优异，尤其在新颖开放世界任务中表现突出。更多详情，请访问：pavlm-source.github.io。
