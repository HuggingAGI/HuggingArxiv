...
> 多模态大型语言模型（MLLMs）在视觉与语言任务中表现出色，但庞大的模型规模和高昂的计算成本限制了其在消费级GPU和边缘设备上的应用。为此，我们推出了Mini-InternVL，一系列参数仅为1B至4B的MLLMs，却能以5%的参数达到90%的性能。这一显著的效率提升，使得我们的模型在实际应用中更加便捷。此外，我们还开发了一个统一的适应框架，让Mini-InternVL在自动驾驶、医学影像和遥感等下游任务中表现卓越。我们相信，这项研究将为高效多模态模型的开发提供宝贵资源。代码已公开，详见https://github.com/OpenGVLab/InternVL。
