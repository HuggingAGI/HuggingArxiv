...
> 预测人类行为对 AI 系统在现实世界中的应用至关重要，如自主机器人协助人类任务。然而，现实场景中的遮挡和不完整观察常影响预测准确性，使传统视频方法受限。大型语言模型 (LLM) 通过大量文本训练，可能在家居环境中编码了人类行为的合理序列，但缺乏空间意识和实时感知。为此，我们提出多模态预测框架，结合物理约束增强 LLM 的动作预测。实验显示，结合轨迹数据显著提升预测性能，特别是在 LLM 信息有限时，突显了语言知识与物理约束的互补性。
