...
> 近年来，大型语言模型 (LLM) 在 NLP 任务中表现出色。研究者们致力于提升其逻辑推理能力，如思维链、自我一致性思维链、思维树和多代理辩论。在多代理辩论中，代理数量和辩论轮次的增加能显著提升性能，但也会大幅增加令牌成本，限制了技术的扩展性。为此，本文提出了一种新方法，通过将代理分组辩论并共享中间结果，显著降低令牌成本。实验表明，该方法能减少辩论中高达 51.7% 的令牌使用，并可能提高 25% 的准确性。这一创新显著提升了多代理辩论的效率和效果。
