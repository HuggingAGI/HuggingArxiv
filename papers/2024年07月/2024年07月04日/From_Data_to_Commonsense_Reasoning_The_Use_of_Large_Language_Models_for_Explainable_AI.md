...
> 常识推理对计算机而言颇具挑战，但对AI至关重要。它通过赋予AI模型提供直观、类人解释的能力，增强了模型的可解释性。这在问答（QA）等众多领域尤为关键，而QA是自然语言处理（NLP）的核心任务之一。随着时间推移，多种方法应运而生，如基于形式逻辑或语言分析的知识库方法，旨在解决常识推理难题。本文探讨了大型语言模型（LLMs）在不同QA任务中的表现，特别关注其推理与可解释性。我们分析了GPT-3.5、Gemma和Llama 3三个模型，并通过问卷评估了它们的表现。结果显示，LLMs在利用常识推理方面超越了人类，GPT-3.5在多个QA基准上的准确率介于56%至93%，而Llama 3在所有十一个数据集上的平均准确率高达90%，平均超越人类21%。此外，GPT-3.5在提供决策解释方面表现出色，66%的问卷参与者给予了“良好”或“优秀”的评价。这些发现不仅深化了我们对当前LLMs的理解，也为未来在推理与可解释性领域的研究奠定了基础。
...
![大型语言模型助力AI可解释性：从数据到常识推理的跃迁](../../../paper_images/2407.03778/x1.png)

![大型语言模型助力AI可解释性：从数据到常识推理的跃迁](../../../paper_images/2407.03778/x2.png)

![大型语言模型助力AI可解释性：从数据到常识推理的跃迁](../../../paper_images/2407.03778/x3.png)

![大型语言模型助力AI可解释性：从数据到常识推理的跃迁](../../../paper_images/2407.03778/x4.png)

![大型语言模型助力AI可解释性：从数据到常识推理的跃迁](../../../paper_images/2407.03778/x5.png)

![大型语言模型助力AI可解释性：从数据到常识推理的跃迁](../../../paper_images/2407.03778/x6.png)
